...
const Navbar = () => {
    ...
    const navOptions = <>
        ...
        <li className="hover:bg-neutral-400 py-1 px-2 rounded transition"><Link to="/all-courses">Courses</Link></li>
    </>
            ...
            <div className="navbar-end font-semibold">
                {
                    user ? <>
                        ...
                        <div className="dropdown dropdown-end pr-2">
                            ...
                            <Link className="hover:bg-neutral-500 py-2 px-3 rounded transition  uppercase" to="/">Dashboard</Link>
                        ...
                        <Link className="hover:bg-neutral-400 py-2 px-3 rounded transition font-bold text-xl pr-4 text-white" to="/login">Login</Link>
                }
            </div>
